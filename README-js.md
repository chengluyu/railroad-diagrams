⚠️ **LLM-REWRITTEN PROJECT** ⚠️
================================

> **This is a TypeScript rewrite of the original JavaScript library, automatically generated by an LLM.**
>
> The original [tabatkins/railroad-diagrams](https://github.com/tabatkins/railroad-diagrams) has been refactored into a modular TypeScript architecture with:
> - **455 comprehensive tests**
> - **Portable SVG output** (`USE_CSS_CLASSES` option)
> - Full type safety and modern ES modules
>
> See the [Original Project](https://github.com/tabatkins/railroad-diagrams) for the official JavaScript version.
