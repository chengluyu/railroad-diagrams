...
> **This repository contains a complete rewrite of the original [tabatkins/railroad-diagrams](https://github.com/tabatkins/railroad-diagrams) project, automatically generated by an LLM (Large Language Model).**
>
> The original JavaScript codebase has been refactored into **TypeScript** with a modular architecture, comprehensive test suite (455 tests), and additional features like the `USE_CSS_CLASSES` option for portable SVG output.
>
> See the [Original Project](https://github.com/tabatkins/railroad-diagrams) for the official version.
